        ...
        <nav className="bg-gray-50 dark:bg-pink-800 shadow">
            <div className="flex flex-row justify-between  mx-auto items-center py-2  px-5 max-w-screen-lg ">
                ...
                <div className="rounded relative w-full max-w-xl mr-6 focus-within:text-purple-500">
                        ...
                        <input type="text" className="rounded py-2 border block w-full text-sm focus:outline-none dark:text-gray-300 form-input leading-5 focus:border-gray-700 dark:border-gray-700 focus:shadow-outline-purple dark:focus:border-gray-600 dark:focus:shadow-outline-gray dark:bg-grey-300 pl-8 text-gray-400 focus:ring-2 focus:ring-gray-400"
