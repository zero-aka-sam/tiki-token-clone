...
const tikiContractAddress = '0x39dbfaca59e95a552d218441b4674d1cf164b7a0'
            ...
            <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-4  ">
              <div className="min-w-0 rounded-lg shadow-xs overflow-hidden bg-white dark:bg-red-400">
                <div className="p-4 flex items-center">
                  ...
                  <div>
                    <p className="mb-2 text-m align-bottom font-semibold text-gray-600 dark:text-gray-100">Your Holdings</p>
              ...
              <div className="min-w-0 rounded-lg shadow-xs overflow-hidden bg-white dark:bg-red-400">
                <div className="p-4 flex items-center">
                  ...
                  <div>
                    <p className="mb-2 text-m align-bottom font-semibold text-gray-600 dark:text-gray-100">Total BNB Paid</p>
              ...
              <div className="min-w-0 rounded-lg shadow-xs overflow-hidden bg-white dark:bg-red-400">
                <div className="p-4 flex items-center">
                  ...
                  <div>
                    <p className="mb-2 text-m align-bottom font-semibold text-gray-600 dark:text-gray-100">Last Payout Time</p>
              ...
              <div className="min-w-0 rounded-lg shadow-xs overflow-hidden bg-white dark:bg-red-400">
                <div className="p-4 flex items-center">
                  ...
                  <div>
                    <p className="mb-2 text-m align-bottom font-semibold text-gray-600 dark:text-gray-100">Payout Loading</p>
